...
import { BufferGeometry, Camera, LoadingManager, Mesh, MeshToonMaterial, PerspectiveCamera, Scene, SpotLight } from "three";
...
export function Head() {
  ...
  function init() {
    ...
    const texture = new THREE.CubeTextureLoader().load( Array(6).fill('./assets/stars.jpg') );
    ...
    loader.load("./assets/LeePerrySmith.glb", function (gltf) {
      createScene(gltf.scene.children[0].geometry, 50, material);
    });
